...
Dependency.prototype.getParent = function() {
  if (this.pomXml.project && this.pomXml.project.parent) {
    var p = this.pomXml.project.parent[0];
    return Dependency.createFromXmlObject(p);
  }
  return null;
};
...
Dependency.prototype.getDependencies = function() {
  if (
    ...
    return dependencies.map(Dependency.createFromXmlObject);
  }
  return [];
};
...
Dependency.createFromObject = function(obj) {
...
Dependency.createFromXmlObject = function(xml) {
